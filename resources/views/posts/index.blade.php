            ...
            <table class="min-w-full table-auto border">
                <thead class="border-b">
                    <tr>
                        ...
                        <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-center">Create At
                        </th>
                ...
                <tbody>
                    @forelse ($posts as $post)
                        <tr class="border-b">
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ $post->title }}
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">
                                {{ $post->status == 0 ? 'Draft' : 'Publish' }}</td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">
